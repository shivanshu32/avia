                ...
                <div className="w-full rounded shadow bg-white dark:bg-gray-800 py-6 pl-6 pr-12">
                    ...
                    <div className="md:flex items-center justify-between">
                        <div className="flex items-center">
                            ...
                            <div className="pl-4">
                                <p className="w-11 text-lg font-semibold leading-none text-gray-800 dark:text-gray-100">12</p>
                                <p className="w-8 text-xs leading-3 text-gray-500 pt-2 dark:text-gray-400">Consultations</p>
                            </div>
                        </div>
                        <div className="flex items-center md:pt-0 pt-4 md:pl-10">
                            ...
                            <div className="pl-4">
                                <p className="w-11 text-lg font-semibold leading-none text-gray-800 dark:text-gray-100">92</p>
                                <p className="w-8 text-xs leading-3 text-gray-500 pt-2 dark:text-gray-400">Patients</p>
                            </div>
                        </div>
                        <div className="flex items-center md:pt-0 pt-4 md:pl-10">
                            ...
                            <div className="pl-4">
                                ...
                                <p className="w-8 text-xs leading-3 text-gray-500 pt-2 dark:text-gray-400">Appointments</p>
                            </div>
                        </div>
                        <div className="flex items-center md:pt-0 pt-4 md:pl-10">
                            ...
                            <div className="pl-4">
                                <p className="w-11 text-lg font-semibold leading-none text-gray-800 dark:text-gray-100">₹7350</p>
                                <p className="w-8 text-xs leading-3 text-gray-500 pt-2 dark:text-gray-400">Billing</p>
                            </div>
                        </div>
                    </div>
                </div>
